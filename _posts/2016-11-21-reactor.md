...
Next, we'll define our entity class. We do not use CQRS explicitly here and
instead rely on Cassandra's implementation. This does limit us a bit, but since
our API is simple, this isn't an issue in practice.
...
building in direct support for Reactor and RxJava into Spring Web.
